 ...
 *   handlers = {
 *     "form" = {
 *       "add" = "Drupal\event_registration\Form\EventTypeForm",
 *       "edit" = "Drupal\event_registration\Form\EventTypeForm",
 *       "delete" = "Drupal\Core\Entity\EntityDeleteForm",
 *     },
 *     "list_builder" = "Drupal\event_registration\EventTypeListBuilder",
 *     "route_provider" = {
